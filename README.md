> **_NOTE:_**  
> Данный репозиторий создан для выполнения самостоятельной работы по предмету "Прикладное программирование" на тему Архитектура фронтенда: модель MVC(model-views-controller)
